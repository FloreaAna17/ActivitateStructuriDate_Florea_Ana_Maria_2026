...
//			heap.vector[heap.nrElementeVizibile++] = m;*/
//			heap.vector[heap.nrElementeVizibile++] = citireMasinaDinFisier(f);
//		}
//	}
//	fclose(f);
//
...
//	}*/
//	//filtrarea se face de la ultimul parinte pana la primul
...
//		filtreazaHeap(*heap, 0);
//		//edge case filtreaza tot heap ul din nou pentru mentinerea structurii
//	}
//	return aux;
//}
//
